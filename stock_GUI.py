# -*- coding: utf-8 -*-
"""
Created on Tue Oct 11 19:45:10 2022
...
class StockApp:
    def __init__(self):
        ...
        # Create Window
        self.root = Tk()
        self.root.title("Faith's Stock Manager")
    ...
    def add_stock(self):
        new_stock = Stock(self.addSymbolEntry.get().upper(), self.addNameEntry.get().upper(), float(self.addSharesEntry.get()))

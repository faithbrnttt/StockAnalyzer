# -*- coding: utf-8 -*-
"""
Created on Wed Sep 28 12:45:04 2022

@author: faith
"""
#Faith Burnett 10/04/2022
...
def add_stock(stock_list):
    ...
    while option != "0":
        os.system('cls')
        sleep(1)
        print(figlet_format("Add Stock", font = "small"))
...
def delete_stock(stock_list):
    os.system('cls')
    sleep(1)
    print(figlet_format("Delete Stock", font = "small"))
...
def list_stocks(stock_list):
    os.system('cls')
    sleep(1)
    print(figlet_format("Stock List", font = "small"))
...
def add_stock_data(stock_list):
    os.system('cls')
    sleep(1)
    print(figlet_format("Add Stock Data", font = "small"))
    print("Stock List: [",end="")
    for stock in stock_list:
        print(stock.symbol," ",end="")
    print("]")
...
def investment_type(stock_list):
    os.system('cls')
    sleep(1)
    print(figlet_format("Investment Account", font = "small"))
...
def display_chart(stock_list):
    os.system('cls')
    sleep(1)
    print(figlet_format("Stock Chart", font = "small"))
    print("Stock List: [",end="")
    for stock in stock_list:
        print(stock.symbol," ",end="")
    print("]")
...
def import_stock_csv(stock_list):
    os.system('cls')
    sleep(1)
    print(figlet_format("Stock Data", font = "small"))
    print("Stock List: [", end="")
    for stock in stock_list:
        print(stock.symbol," ",end="")
    print("]")
        ...
        if stock.symbol == symbol:
            with open(filename, newline="") as stockdata:
                ...
                for row in datareader:
                    daily_data = DailyData(row[0],float(row[4]), float(row[6]))
...
def display_report(stock_list):
    os.system('cls')
    sleep(1)
    print(figlet_format("Stock Report", font = "small"))
    for stock in stock_list:
        ...
        if count > 0:
            ...
            print("Average price: $",price_total / count)
...
def main_menu(stock_list):
    ...
    while True:
        os.system('cls')
        sleep(1)
        print(figlet_format("Stock Analyzer", font = "small"))
        print("1 - Add Stock")
        print("2 - Delete Stock")
        print("3 - List stocks")
        print("4 - Add Stock Data (Date, Price, Volume)")
        print("5 - Show Chart")
